class Difference:
    ...
    def computeDifference(self):
        ...
        maximumNumber = 0
        minimumNumber = self.__elements[0]
        for i in range(len(self.__elements)):
            if self.__elements[i] >= maximumNumber:
                maximumNumber = self.__elements[i]
            if self.__elements[i] <= minimumNumber:
                minimumNumber = self.__elements[i]
        self.maximumDifference = maximumNumber - minimumNumber
