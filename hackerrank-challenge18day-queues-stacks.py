...
class Solution:
    ...
    def pushCharacter(self, char):
        self.listStack.append(char)

    def enqueueCharacter(self, char):
        self.enqueueList.append(char)

    def popCharacter(self):
        return (self.listStack.pop())

    def dequeueCharacter(self):
        firstChar = self.enqueueList[0]
        self.enqueueList.remove(self.enqueueList[0])
        return firstChar
        # return (self.enqueueList.pop(0))
